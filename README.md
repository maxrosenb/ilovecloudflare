...
An application that will randomly send users to one of two webpages. This project taught me a lot about Cloudflare Worker and its Runtime APIs. I enjoyed the project and appreciate the oppurtunity to apply to cloudflare.
